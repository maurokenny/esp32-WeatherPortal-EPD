...
void updateWeather()
{
  ...
  // In AUTO mode, pass the API timezone offset to convert UTC to local time for display
  // Other time values (sunrise, sunset, hourly) already come from API in local time
